...
local iyassets = {
    ...
    ["infiniteyield/assets/logo.png"] = "rbxassetid://108576666797778",
    ...
    pcall(function() -- good executor trust
        ...
        for path in iyassets do
            if not isfile(path) then
                writefile(path, game:HttpGet((path:gsub("infiniteyieldforsakenuniversal/", assets))))
            end
        end
        if IsOnMobile then writefile("infiniteyieldforsakenuniversal/assets/.nomedia") end
    end)
end
